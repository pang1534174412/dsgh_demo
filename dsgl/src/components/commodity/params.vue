        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          ...
          <el-tab-pane label="动态参数" name="many">
            <el-button
              class="add"
              type="primary"
              @click="addparameter((dialogVisible = true))"
              :disabled="disabled"
              >添加属性</el-button
            >
            <el-table
            ...
            >
              <el-table-column label="" width="60" type="expand">
                <template slot-scope="" class="dynamic_a">
                  <el-form
                    label-position="left"
                    inline
          ...
          >
            ...
            <span slot="footer" class="dialog-footer">
              ...
              <el-button :plain="true" type="primary" @click="cimitparam"
                >确 定</el-button
              >
            </span>
          </el-dialog>
          ...
          <el-tab-pane label="静态参数" name="only" value="静态参数">
            <div class="but">
              <el-button
                @click="addstatis((staticVisible = true))"
                type="primary"
                :disabled="disabled"
                >添加属性</el-button
              >
          ...
          >
            ...
            <span slot="footer" class="dialog-footer">
              <el-button :plain="true" @click="open1">取 消</el-button>
              <el-button :plain="true" type="primary" @click="cimitstatic"
                >确 定</el-button
              >
            </span>
          </el-dialog>
          ...
          >
            ...
            <span slot="footer" class="dialog-footer">
              <el-button :plain="true" @click="open1">取 消</el-button>
              <el-button :plain="true" type="primary" @click="deletecommit"
                >确 定</el-button
              >
            </span>
          </el-dialog>
